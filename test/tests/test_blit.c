...
*
*   Description:
*       Renders one solid-colored rectangle and one semi-transparent using a
*       custom graphics library called Picasso. Also loading a bmp and
*       displaying that, all under a transparent circle. One red square
*       outlined moving to test clipping and boundries, and one outlined circle
*       movin to test boundries and drawing. Demonstrates how to fill, blit,
*       and display a custom backbuffer using Canopy.
*
*   Controls:
